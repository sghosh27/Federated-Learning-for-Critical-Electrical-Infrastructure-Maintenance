...
- **`Federated_Learning_for_Breaker_Advanced.ipynb`**:  
  - **`HV_Circuit_Breaker_Maintenance_Data.xlsx`** (located in the `Datasets` folder).  
  - **`common_functions.py`** (located in the `Functions` folder).

- **`Federated_Learning_for_Transformer.ipynb`**:  
  - **`Large_Power_Transformer_Maintenance_Data.xlsx`** (located in the `Datasets` folder).  
  - **`common_functions.py`** (located in the `Functions` folder).

- **`Federated Learning for Generator.ipynb`**:  
  - **`Emergency_Station_Generator_Maintenance_Data.xlsx`** (located in the `Datasets` folder).  
  - **`common_functions.py`** (located in the `Functions` folder).
